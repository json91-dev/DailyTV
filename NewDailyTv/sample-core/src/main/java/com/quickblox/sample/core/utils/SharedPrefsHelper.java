...
public class SharedPrefsHelper {
    ...
    //동기화를 해놓는다 => 동시에 여러번 접근할때 충돌이 없도록
    //static을 사용한다.. 여러 액티비티에서 정적으로 접근이 가능하다.

    //만약 instance가 없으면 생성하여 반환한다.
    ...
    //이 클래스가 생성되면 Coreapp의 인스턴스를 얻고 sharedpreperence 를 가져온다.

    private SharedPrefsHelper() {
        instance = this;

        //CoreApp으로부터 SharedPreperence를 얻어온다.
    ...
    // coreapp의 sharedpreperence에 Key에 맞는 값을 저장하는 부분
